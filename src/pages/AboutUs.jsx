    ...
    return (
        <div className="min-h-screen flex bg-pink-900 shadow-2xl items-center justify-center" id="about-us-section">
            <div className="grid grid-cols-2 bg-gray-100 lg:w-full lg:m-3 rounded-xl shadow-2xl">
                ...
                <div className=" flex flex-col lg:m-5 justify-center">
                    <motion.div className="lg:text-8xl font-medium font-serif tracking-wider lg:py-3 lg:m-2"
                    ...
                    <motion.div
                        ...
                        <p className="text-3xl text-center font-serif font-semibold tracking-widest text-gray-800 ">
