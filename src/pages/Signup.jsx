...
export default function SignUp() {
    ...
    return (
        ...
        <div>
            ...
            <div className="relative md:grid grid-cols-2 min-h-screen bg-linear-to-br from-gray-900 via-gray-900 to-gray-950">

                <div
                    className="absolute inset-0 bg-center bg-cover blur-sm rounded-2xl shadow-2xl"
                ...
                <div className="relative text-white flex flex-col items-center px-4 md:px-8 py-4 md:py-60 ">
                    <div className="flex flex-col gap-4 ">
                        <p className="md:text-7xl text-5xl shadow-2xl">Create Your <br /> Free Account </p>

                        <p className=" shadow-2xs text-xl md:text-2xl text-gray-200 opacity-85">Grab your offers on time, Share with your firends</p>
                    ...
                    <div className=" flex flex-col justify-center text-black  items-center  opacity-90 shadow-2xl rounded-2xl py-4">
                        ...
                        <form className="flex p-10 flex-col gap-2 items-center justify-center" onSubmit={handleSubmit}>
                            ...
                            <div className="flex flex-col gap-2 p-2  font-sans">
                                ...
                                <input className="outline-2 outline-gray-500 rounded-xl p-2 md:w-100 w-full max-w-md px-20  hover:outline-gray-300 text-gray-800 hover:scale-102 duration-600"
